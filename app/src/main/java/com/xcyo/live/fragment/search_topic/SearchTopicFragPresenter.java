...
import com.xcyo.live.fragment.search_user.SearchUserFragRecord;
import com.xcyo.live.utils.ServerEvents;

/**
 * Created by lovingyou on 2016/6/3.
 */
public class SearchTopicFragPresenter extends BaseFragmentPresenter<SearchTopicFragment,SearchUserFragRecord> {
    @Override
