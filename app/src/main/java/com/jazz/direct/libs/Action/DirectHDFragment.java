 ...
 */
public class DirectHDFragment extends DirectMainFragment{

    private com.netease.livestreamingFilter.view.CameraSurfaceView surfaceView;

    @Override
    protected View getDirectSurfaceView() {
        return surfaceView = surfaceView != null ? surfaceView : new com.netease.livestreamingFilter.view.CameraSurfaceView(activity);
    }
    ...
    @Override
    protected void startVideoPreView(lsMediaCapture mLSMediaCapture, lsMediaCapture.LSLiveStreamingParaCtx mLSLiveStreamingParaCtx) {
        mLSMediaCapture.startVideoPreviewOpenGL(surfaceView, mLSLiveStreamingParaCtx.sLSVideoParaCtx.cameraPosition.cameraPosition);
    }
    ...
    protected View configControllerView() {
        ...
        Button filterButton = ViewUtils.createSwitchButton(activity);
        filterButton.setId(R.id.direct_controller_filter);
        filterButton.setText("滤镜");
    ...
    protected void addClickEvent() {
        ...
        dispatchClickEvent(mFrame.findViewById(R.id.direct_controller_filter));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.direct_controller_switch_bitrate:
                break;
            case R.id.direct_controller_filter:
                mHelper.showFilterDialog(activity, getLSMediaCapture());
                break;
        }
    }
    ...
    public void onResume() {
        ...
        mFilter.addAction(DirectUtils.Action.ACTION_FILTER);
    ...
    protected BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            }else if(DirectUtils.Action.ACTION_FILTER.equals(action)){
                mHelper.showFilterDialog(activity, getLSMediaCapture());
